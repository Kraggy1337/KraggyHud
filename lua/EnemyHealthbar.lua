if string.lower(RequiredScript) == "lib/managers/hudmanager" then
	HUDManager.CharacterData = {
		[ "civilian" ] 						= { default = "KraggyHUD_enemy_civilian" },
		[ "civilian_female" ] 				= { default = "KraggyHUD_enemy_civilian" },
		[ "captain" ] 						= { default = "KraggyHUD_enemy_civilian" },
		[ "gangster" ] 						= { default = "KraggyHUD_enemy_gangster" },
		[ "biker" ] 						= { default = "KraggyHUD_enemy_biker" },
		[ "biker_escape" ] 					= { default = "KraggyHUD_enemy_biker" },
		[ "bolivian_indoors" ]				= { default = "KraggyHUD_enemy_bolivian_security" },
		[ "bolivian" ]						= { default = "KraggyHUD_enemy_bolivian_thug" },
		[ "mobster" ] 						= { default = "KraggyHUD_enemy_mobster" },
		[ "security" ] 						= { default = "KraggyHUD_enemy_security" },
		[ "security_undominatable" ] 		= { default = "KraggyHUD_enemy_security" },
		[ "gensec" ] 						= { default = "KraggyHUD_enemy_gensec" },
		[ "cop" ] 							= { default = "KraggyHUD_enemy_cop" },
		[ "cop_female" ]					= { default = "KraggyHUD_enemy_cop" },
		[ "cop_scared" ]					= { default = "KraggyHUD_enemy_cop" },
		[ "fbi" ] 							= { default = "KraggyHUD_enemy_fbi" },
		[ "swat" ] 							= { default = "KraggyHUD_enemy_swat" },
		[ "heavy_swat" ] 					= { default = "KraggyHUD_enemy_heavy_swat" },
		[ "fbi_swat" ] 						= { default = "KraggyHUD_enemy_swat" },
		[ "fbi_heavy_swat" ] 				= { default = "KraggyHUD_enemy_heavy_swat" },
        [ "heavy_swat_sniper" ]             = { default = "KraggyHUD_enemy_heavy_swat_sniper" },
		[ "city_swat" ] 					= { default = "KraggyHUD_enemy_city_swat" },
		[ "shield" ] 						= { default = "KraggyHUD_enemy_shield" },
		[ "spooc" ] 						= { default = "KraggyHUD_enemy_spook" },
		[ "taser" ] 						= { default = "KraggyHUD_enemy_taser" },
		[ "sniper" ] 						= { default = "KraggyHUD_enemy_sniper" },
		[ "medic" ]							= { default = "KraggyHUD_enemy_medic" },
		[ "tank" ] 							= { default = "KraggyHUD_enemy_tank" },
		[ "tank_hw" ]						= { default = "KraggyHUD_enemy_tank_hw" },
        [ "tank_medic" ]                    = { default = "KraggyHUD_enemy_tank_medic" },
        [ "tank_mini" ]                     = { default = "KraggyHUD_enemy_tank_mini" },
		[ "phalanx_minion" ] 				= { default = "KraggyHUD_enemy_phalanx_minion" },
		[ "phalanx_vip" ] 					= { default = "KraggyHUD_enemy_phalanx_vip" },
		[ "swat_van_turret_module" ] 		= { default = "KraggyHUD_enemy_swat_van" },
		[ "ceiling_turret_module" ] 		= { default = "KraggyHUD_enemy_ceiling_turret" },
		[ "ceiling_turret_module_no_idle" ] = { default = "KraggyHUD_enemy_ceiling_turret" },
		[ "sentry_gun" ]					= { default = "KraggyHUD_enemy_sentry_gun" },
		[ "mobster_boss" ] 					= { default = "KraggyHUD_enemy_mobster_boss" },
		[ "chavez_boss" ]					= { default = "KraggyHUD_enemy_chavez_boss" },
		[ "drug_lord_boss" ]				= { default = "KraggyHUD_enemy_druglord_boss" },
		[ "drug_lord_boss_stealth" ]		= { default = "KraggyHUD_enemy_druglord_boss_stealth" },
		[ "biker_boss" ] 					= { default = "KraggyHUD_enemy_biker_boss" },
		[ "bank_manager" ] 					= { default = "KraggyHUD_enemy_bank_manager" },
		[ "inside_man" ] 					= { default = "KraggyHUD_enemy_inside_man" },
		[ "escort_undercover" ] 			= { default = "KraggyHUD_enemy_escort_undercover", run = "KraggyHUD_enemy_escort_heatstreet" },
		[ "escort_chinese_prisoner" ]		= { default = "KraggyHUD_enemy_escort_chinese_prisoner" },
		[ "escort_cfo" ]					= { default = "KraggyHUD_enemy_escort_cfo" },
		[ "drunk_pilot" ] 					= { default = "KraggyHUD_enemy_drunk_pilot" },
		[ "escort" ] 						= { default = "KraggyHUD_enemy_escort" },
		[ "boris" ]							= { default = "KraggyHUD_enemy_boris" },
		[ "spa_vip" ]						= { default = "KraggyHUD_enemy_spa_vip" },
		[ "spa_vip_hurt" ]					= { default = "KraggyHUD_enemy_spa_vip_hurt" },
		[ "old_hoxton_mission" ] 			= { default = "KraggyHUD_enemy_locke_mission", hox_1 = "KraggyHUD_enemy_old_hoxton_mission", hox_2 = "KraggyHUD_enemy_old_hoxton_mission" },
		[ "hector_boss" ] 					= { default = "KraggyHUD_enemy_hector_boss" },
		[ "hector_boss_no_armor" ] 			= { default = "KraggyHUD_enemy_hector_boss_no_armor" },
		[ "robbers_safehouse" ]				= { default = "KraggyHUD_enemy_crew" },
		[ "butler" ]						= { default = "KraggyHUD_enemy_butler" },
		[ "vlad" ]							= { default = "KraggyHUD_enemy_vlad" },
		[ "boom" ]					 		= { default = "KraggyHUD_enemy_boom" },
		[ "omnia_lpf" ]						= { default = "KraggyHUD_enemy_omnia_lpf" },
		[ "summers" ]					 	= { default = "KraggyHUD_enemy_summers" },
		[ "boom_summers" ]					= { default = "KraggyHUD_enemy_boom_summers" },
		[ "taser_summers" ]					= { default = "KraggyHUD_enemy_taser_summers" },
		[ "medic_summers" ]					= { default = "KraggyHUD_enemy_medic_summers" },
		[ "spring" ]						= { default = "KraggyHUD_enemy_spring" },
		[ "fbi_vet" ]					 	= { default = "KraggyHUD_enemy_fbi_vet" },
	...
	Hooks:PostHook( HUDManager , "_player_hud_layout" , "KraggyHUDPostHUDManagerPlayerInfoHUDLayout" , function( self )
		...
		self._unit_health_enemy_location = self._unit_health_panel:text({
			...
			text 		= "^",
			blend_mode 	= "normal",
			visible 	= KraggyHUD:getSetting({"EnemyHealthbar", "SHOW_POINTER"}, false),
			alpha 		= 0.75,
			halign 		= "center",
			font 		= "fonts/font_medium_shadow_mf",
			font_size 	= 20,
	...
	function HUDManager:set_unit_health_visible( visible, shield )
		...
		if visible == true and not self._unit_health_visible and KraggyHUD:getSetting({"EnemyHealthbar", "ENABLED"}, true) then

			self._unit_health_visible = true
			self._unit_health_enemy_location:set_visible(KraggyHUD:getSetting({"EnemyHealthbar", "SHOW_POINTER"}, false))
...
elseif string.lower(RequiredScript) == "lib/units/beings/player/states/playerstandard" then
	Hooks:PostHook( PlayerStandard , "_update_fwd_ray" , "KraggyHUDPostPlayerStandardUpdate" , function( self , t , dt )
		if self._fwd_ray and self._fwd_ray.unit and type(self._fwd_ray.unit) == "userdata" then
			...
			if alive( unit ) then
				if unit:in_slot( 25 ) and not unit:character_damage():dead() and (table.contains(managers.groupai:state():turrets() or {}, unit) or KraggyHUD:getSetting({"EnemyHealthbar", "SHOW_CIVILIAN"}, true) and Network:is_server()) then
					self._last_unit = nil
					visible = true
				...
				elseif alive( unit ) and ( unit:in_slot( 12 ) or KraggyHUD:getSetting({"EnemyHealthbar", "SHOW_CIVILIAN"}, false) and ( unit:in_slot( 21 ) or unit:in_slot( 22 ) ) or unit:in_slot( 16 ) and Network:is_server()) and not unit:character_damage():dead() then
				...
				elseif alive( unit ) and unit:in_slot( 39 ) and KraggyHUD:getSetting({"EnemyHealthbar", "SHOW_VEHICLE"}, true) and unit:vehicle_driving() and not self._seat then
					self._last_unit = nil
					visible = true
...
elseif string.lower(RequiredScript) == "lib/states/ingamearrested" then
	Hooks:PostHook( IngameArrestedState , "at_enter" , "KraggyHUDPostIngameArrestedAtEnter" , function( self )
